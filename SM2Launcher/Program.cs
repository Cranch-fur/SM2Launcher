    ...
    static class Program
    {
        static void ExceptionHandler(object sender, ThreadExceptionEventArgs e)
        {
            ...
            try
            {
                ...
                string logFile = Path.Combine(tempFolder, $"[{DateTime.UtcNow.ToString("yyyy-MM-dd HH-mm-ss")}] SM2Launcher Fatal Error.txt");
            ...
            {
                MessageBox.Show(exceptionData, "SM2Launcher Fatal Error", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        ...
        static void Main(string[] args)
        {
            ...
            {
                MessageBox.Show(ex.ToString(), "SM2Launcher Application.Run() Failed", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
#else
            Application.Run(new Launcher());
#endif
